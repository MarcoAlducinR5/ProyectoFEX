<script type="text/javascript" src="<?=base_url('application/js/home/newsletter/newsletter.js')?>"></script>
                    ...
                    <div class="panel">
                        ...
                        <div class="col-md-15">
                            <div class="newsletter">
                                <h4>Newsletter</h4>
                                <p>Manténgase al día sobre nuestras características de productos siempre en evolución y 
                                    tecnología. <br> Introduzca su dirección de correo y suscríbete a nuestro boletín.</p>
                                                               
                                <form id="newsletterForm" novalidate="novalidate">
                                    <div class="input-group">
                                        <input class="form-control" placeholder="Email" name="newsletterEmail" id="newsletterEmail" type="email" required>
                                        <input type="hidden" name="seccion" value="principal">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" id="Suscribirse" type="submit">Suscribirse</button>
                                        </span>
                                    </div>
                                </form>
