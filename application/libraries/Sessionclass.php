	...
	function generadinamymenu(){
		...
		foreach ($data as $row) {
			...
			$mainpage = base_url($row["urlpaginaweb"]);	
	         ...
	         $menu .="<li><a href='$mainpage'><i class='".geticon($row["nombre"])."'></i><span>". $row["nombre"]."</span></a></li>";           
	        ...
	        foreach ($datasubpaginas as $row) {
	        	...
	        	$subpaginasli .= "<li><a href='$urlpag'><i class='fa fa-ellipsis-v'></i><span>". $row["nombrepermiso"] ."</span></a></li>";           
