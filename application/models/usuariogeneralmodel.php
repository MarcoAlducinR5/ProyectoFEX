...
/**/
    ...
    function envioAdministrador($idempresa){

      $query_select ="SELECT * FROM  usuario AS u, usuario_perfil AS up WHERE up.idusuario = u.idusuario 
      AND up.idperfil = 4 AND u.idempresa ='".$idempresa."'";
        $result_admin = $this->db->query($query_select);       
        return $result_admin ->result_array();      
