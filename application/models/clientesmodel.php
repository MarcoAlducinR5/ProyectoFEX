 ...
 class clientesmodel extends CI_Model {
    ...
    function clientesbyempresa($idempresa){
      ...
      p.segundoapellido,  p.RFC, p.fecha_registro AS f, p.Comentarios, a.idarchivo, a.nombre , h.idhistorial, 
       ...
       h.ejecutivo, h.nota , h.omisionesgraves , h.puntosTotalescuestionario from personafisica as p , archivo as a , historial_crediticio as h 
    ...
    function clientesmoralesbyempresa($idempresa){
      ...
      hm.fecha, hm.Completoporcentaje,  hm.ejecutivo , hm.omisionesgraves ,
       hm.idhistorial_crediticio_moral , hm.puntosTotalescuestionario from personamoral as pm , archivo as a , historial_crediticio_moral as hm 
...
function surveydocumentclienteorg2( $documento ,  $clienteorg , $historial ){
      ...
      $dynamicqueryrespuesta = "SELECT * FROM  clienteorg_respuesta WHERE idpersonafisica ='".$clienteorg."'  and idhistorial = '".$historial."'  ";
...
private function isomision($pregunta)
{
      ...
      if ($existe >0  ) {
          ...
          //return $resultupdate;
            ...
            if ($respuesta == "yes") {
                    ...
                    $queryinsert = "INSERT INTO clienteorg_respuesta  (idpersonafisica , idpregunta, respuesta , omision, idhistorial )  
                    VALUES('".$idcostomer."' , '".$pregunta."' , '".$respuesta."' , '0', '".$historial."')";
                   ...
                   if ($bandera > 0) { 
                        ...
                        $queryinsert = "INSERT INTO clienteorg_respuesta  (idpersonafisica , idpregunta, respuesta , omision, idhistorial )  
                        VALUES('".$idcostomer."' , '".$pregunta."' , '".$respuesta."' , '1' , '".$historial."')";
                        $resultinsert = $this->db->query($queryinsert);
...
*/
  ...
  private function existClienteorgRespuesta($idcostomer , $pregunta){
...
private function choiceBehindUpdate($respuesta , $idcostomer , $pregunta , $historial,   $isomision){

    if ($respuesta ==  "yes"){
            

                  $queryupdate = $this-> updateclienteorgrespuata($idcostomer, $pregunta , $respuesta, '0' , $historial );
                  if ($isomision > 0 ) {

                      $updatesolicitud = "UPDATE historial_crediticio SET
                       omisionesgraves = omisionesgraves - '1'  WHERE idhistorial='".$historial."'" ;   
                      $this->db->query( $updatesolicitud);
                ...
                if ($isomision == 0 ) {           
                      ...
                      $queryupdate = $this-> updateclienteorgrespuata($idcostomer, $pregunta , $respuesta, '1' , $historial );
...
private function  updateclienteorgrespuata($idcostomer, $pregunta , $respuesta, $omision , $historial ){

   $queryupdate = "UPDATE clienteorg_respuesta  SET respuesta = '".$respuesta."' , 
   omision ='". $omision ."' WHERE 
   idpersonafisica ='".$idcostomer."' AND idpregunta ='".$pregunta."' ";
...
private function choiceBehindCreate($respuesta , $idcostomer , $pregunta, $historial , $isomision){
   
   if ($respuesta == "yes") {

                return $this->createclienteorgrespuata($idcostomer, $pregunta , $respuesta, '0' , $historial );
    }else{
          
           if($isomision > 0) { 
                    $this->createclienteorgrespuata($idcostomer, $pregunta , $respuesta, '1' , $historial );
                    $updatesolicitud = "UPDATE historial_crediticio SET omisionesgraves = omisionesgraves + '1'  
                    WHERE idhistorial='".$historial."'" ;   
                    
                    return $this->db->query( $updatesolicitud);
...
private function createclienteorgrespuata($idcostomer, $pregunta , $respuesta, $omision , $historial ){
    
    $queryinsert = "INSERT INTO clienteorg_respuesta  (idpersonafisica , idpregunta, respuesta , 
    omision, idhistorial )   VALUES('".$idcostomer."' , '".$pregunta."' , '".$respuesta."' ,
    '". $omision."' , '".$historial."')";
  ...
  function updaterespuesta( $typeclient  , $pregunta , $idcostomer , $respuesta, $historial, $documento_s){

      $costomer = new Cliente( $typeclient , $pregunta , $idcostomer , $respuesta, $historial, $documento_s);    
      $existe = $this->existClienteorgRespuesta( $costomer -> getIdcostomer() , $costomer->getPregunta());
      $isomision = $this->isomision($costomer->getPregunta());


      if($existe > 0 ){

          return  $this->choiceBehindUpdate($costomer-> getRespuesta() , $costomer -> getIdcostomer() , $costomer-> getPregunta() , $costomer->getHistorial() , $isomision);

      }else{


          return $this->choiceBehindCreate( $costomer-> getRespuesta() ,  $costomer -> getIdcostomer() ,  $costomer-> getPregunta() , $costomer->getHistorial() , $isomision );
          ...
          //return $resultupdate;
            ...
            if ($respuesta == "yes") {
                    ...
                    $queryinsert = "INSERT INTO clienteorgmoral_respuesta  (idpersonamoral , idpregunta ,
                     respuesta , omision , idhistorialcrediticiomoral )  
                    VALUES('".$idcostomer."' , '".$pregunta."' , '".$respuesta."' , '0' , $historial )";
                    $resultinsert = $this->db->query($queryinsert);
            }else{
                    ...
                    if ($bandera > 0) { 
                        ...
                        $queryinsert = "INSERT INTO clienteorgmoral_respuesta  (idpersonamoral , idpregunta, respuesta , omision, idhistorialcrediticiomoral )  
                        VALUES('".$idcostomer."' , '".$pregunta."' , '".$respuesta."' , '1' , $historial)";
                        $resultinsert = $this->db->query($queryinsert);
...
function documenta($iddocumento  , $idclienteorg, $respuesta ){
 ...
 function setpuntosHistorial($puntos , $historial, $tipo)
{


  if ($tipo == 0) {
    
     $queryupdate = "UPDATE  historial_crediticio SET puntosTotalescuestionario = '".$puntos."'  WHERE  idhistorial = '".$historial."' ";
    return $this->db->query($queryupdate);
  
  }else{

    $queryupdate = "UPDATE  historial_crediticio_moral SET puntosTotalescuestionario = '".$puntos."'  WHERE  idhistorial_crediticio_moral = '".$historial."' ";
    return $this->db->query($queryupdate);
  }
